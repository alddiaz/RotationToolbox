...
q(1,1) = 0.25*sqrt((1+R(1,1)+R(2,2)+R(3,3))^2 + (R(2,3)-R(3,2))^2 + (R(3,1)-R(1,3))^2 + (R(1,2)-R(2,1))^2);
q(2,1) = 0.25*sqrt((R(2,3)-R(3,2))^2 + (1+R(1,1)-R(2,2)-R(3,3))^2 + (R(1,2)+R(2,1))^2 + (R(1,3)+R(3,1))^2);
q(3,1) = 0.25*sqrt((R(3,1)-R(1,3))^2 + (R(1,2)+R(2,1))^2 + (1-R(1,1)+R(2,2)-R(3,3))^2 + (R(2,3)+R(3,2))^2);
q(4,1) = 0.25*sqrt((R(1,2)-R(2,1))^2 + (R(1,3)+R(3,1))^2 + (R(2,3)+R(3,2))^2 + (1-R(1,1)-R(2,2)+R(3,3))^2);
